...
const svgs = {
  ...
  'ic_mic.svg': `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 14c1.66 0 2.99-1.34 2.99-3L15 5c0-1.66-1.34-3-3-3S9 3.34 9 5v6c0 1.66 1.34 3 3 3zm5.3-3c0 3-2.54 5.1-5.3 5.1S6.7 14 6.7 11H5c0 3.41 2.72 6.23 6 6.72V21h2v-3.28c3.28-.48 6-3.3 6-6.72h-1.7z" fill="none" stroke="currentColor" stroke-width="1.5"/></svg>`,
...
replaceInFile('Anywhere_harmony/entry/src/main/ets/pages/Index.ets', [
    ...
    [`Path().commands('M0 0 M24 24 M12 6 a1.5 1.5 0 1 1 0 -3 a1.5 1.5 0 0 1 0 3 M12 13.5 a1.5 1.5 0 1 1 0 -3 a1.5 1.5 0 0 1 0 3 M12 21 a1.5 1.5 0 1 1 0 -3 a1.5 1.5 0 0 1 0 3').fill(Colors.foreground).width(20).height(20)`,
     `Image($r('app.media.ic_dots')).fillColor(Colors.foreground).width(20).height(20)`],
    [`Path().commands('M0 0 M24 24 M4 4 h16 v16 h-16 z M12 4 v16').stroke(Colors.foregroundMuted).strokeWidth(1.5).fill('transparent').width(24).height(24)`,
     `Image($r('app.media.ic_tool')).fillColor(Colors.foregroundMuted).width(20).height(20)`],
    [`Path().commands('M0 0 M24 24 M4 4 h12 v12 h-12 z M8 4 v12 M4 8 h12').stroke(Colors.foreground).strokeWidth(1.5).fill('transparent').width(20).height(20).margin({ right: Spacing.sm })`,
     `Image($r('app.media.ic_panel')).fillColor(Colors.foreground).width(16).height(16).margin({ right: Spacing.sm })`],
    [`Path().commands('M0 0 M24 24 M6 9 l6 6 l6 -6').stroke(Colors.foregroundMuted).strokeWidth(1.5).fill('transparent').width(20).height(20)`,
     `Image($r('app.media.ic_chevron_down')).fillColor(Colors.foregroundMuted).width(16).height(16)`]
]);
...
replaceInFile('Anywhere_harmony/entry/src/main/ets/feature/workspace/WorkspaceDrawer.ets', [
    [`Path().commands('M0 0 M24 24 M6 6 l12 12 M18 6 l-12 12').stroke(Colors.foregroundMuted).strokeWidth(1.5).fill('transparent')\n            .width(20).height(20)`,
     `Image($r('app.media.ic_close')).fillColor(Colors.foregroundMuted).width(16).height(16)`]
]);
...
replaceInFile('Anywhere_harmony/entry/src/main/ets/common/ui/ToolCallCard.ets', [
    [`Path().commands('M0 0 M24 24 M6 12 l4 4 l8 -8').stroke(Colors.success).strokeWidth(1.5).fill('transparent')\n          .width(18).height(18).margin({ right: Spacing.sm })`,
     `Image($r('app.media.ic_check')).fillColor(Colors.success).width(14).height(14).margin({ right: Spacing.sm })`],
    [`Path().commands('M0 0 M24 24 M7 7 l10 10 M17 7 l-10 10').stroke(Colors.error).strokeWidth(1.5).fill('transparent')\n          .width(18).height(18).margin({ right: Spacing.sm })`,
     `Image($r('app.media.ic_error')).fillColor(Colors.error).width(14).height(14).margin({ right: Spacing.sm })`]
]);
...
replaceInFile('Anywhere_harmony/entry/src/main/ets/common/ui/PlanView.ets', [
    [`Path().commands('M0 0 M24 24 M6 12 l4 4 l8 -8').stroke(Colors.success).strokeWidth(1.5).fill('transparent').width(16).height(16).margin({ left: Spacing.sm, top: 2 })`,
     `Image($r('app.media.ic_check')).fillColor(Colors.success).width(14).height(14).margin({ left: Spacing.sm, top: 4 })`],
    [`Path().commands('M0 0 M24 24 M6 12 a1.5 1.5 0 1 1 0 -3 a1.5 1.5 0 0 1 0 3 M12 12 a1.5 1.5 0 1 1 0 -3 a1.5 1.5 0 0 1 0 3 M18 12 a1.5 1.5 0 1 1 0 -3 a1.5 1.5 0 0 1 0 3').fill(Colors.warning).width(16).height(16).margin({ left: Spacing.sm, top: 2 })`,
     `Image($r('app.media.ic_dots')).fillColor(Colors.warning).width(14).height(14).margin({ left: Spacing.sm, top: 4 })`],
    [`Path().commands('M0 0 M24 24 M12 5 a7 7 0 1 1 0 14 a7 7 0 0 1 0 -14').stroke(Colors.foregroundLight).strokeWidth(1.5).fill('transparent').width(16).height(16).margin({ left: Spacing.sm, top: 2 })`,
     `Image($r('app.media.ic_circle')).fillColor(Colors.foregroundLight).width(14).height(14).margin({ left: Spacing.sm, top: 4 })`]
]);
...
replaceInFile('Anywhere_harmony/entry/src/main/ets/common/ui/ThinkingSection.ets', [
    [`Path().commands('M0 0 M24 24 M12 3 L14.5 8.5 L20 11 L14.5 13.5 L12 19 L9.5 13.5 L4 11 L9.5 8.5 Z')\n          .stroke(Colors.foregroundMuted).strokeWidth(1.5).fill('transparent')\n          .width(20).height(20).margin({ right: Spacing.sm })`,
     `Image($r('app.media.ic_thinking')).fillColor(Colors.foregroundMuted).width(16).height(16).margin({ right: Spacing.sm })`]
]);
...
replaceInFile('Anywhere_harmony/entry/src/main/ets/common/ui/MessageCard.ets', [
    [`Path().commands('M0 0 M24 24 M16 1 H4 c-1.1 0-2 .9-2 2 v14 h2 V3 h12 V1 z M15 5 H8 c-1.1 0-2 .9-2 2 v14 c0 1.1 .9 2 2 2 h7 c1.1 0 2-.9 2-2 V7 c0-1.1-.9-2-2-2 z m0 16 H8 V7 h7 v14 z')\n            .fill(Colors.foregroundLight).width(20).height(20)`,
     `Image($r('app.media.ic_copy')).fillColor(Colors.foregroundLight).width(16).height(16)`],
    [`Path().commands('M0 0 M24 24 M16 1 H4 c-1.1 0-2 .9-2 2 v14 h2 V3 h12 V1 z M15 5 H8 c-1.1 0-2 .9-2 2 v14 c0 1.1 .9 2 2 2 h7 c1.1 0 2-.9 2-2 V7 c0-1.1-.9-2-2-2 z m0 16 H8 V7 h7 v14 z')\n                  .fill(Colors.foregroundLight).width(20).height(20)`,
     `Image($r('app.media.ic_copy')).fillColor(Colors.foregroundLight).width(16).height(16)`]
]);

replaceInFile('Anywhere_harmony/entry/src/main/ets/feature/chat/ChatInputBar.ets', [
    [`Image($r('app.media.ic_attachment'))\n            .fillColor(Colors.foreground)\n            .width(40).height(40)`,
     `Image($r('app.media.ic_attachment')).fillColor(Colors.foreground).width(24).height(24)`],
    [`Image($r('app.media.ic_model'))\n              .fillColor(Colors.foregroundMuted).width(28).height(28).margin({ right: Spacing.xs })`,
     `Image($r('app.media.ic_model')).fillColor(Colors.foregroundMuted).width(18).height(18).margin({ right: Spacing.xs })`],
    [`Image($r('app.media.ic_send_active'))\n              .fillColor(Colors.foreground).width(40).height(40).onClick(() => { this.doSend() })`,
     `Image($r('app.media.ic_send_active')).fillColor(Colors.foreground).width(28).height(28).onClick(() => { this.doSend() })`],
    [`Image($r('app.media.ic_send_disabled'))\n              .fillColor(Colors.foreground).width(40).height(40)`,
     `Image($r('app.media.ic_send_disabled')).fillColor(Colors.foreground).width(28).height(28)`],
    [`Path().commands('M0 0 M24 24 M12 14 c1.66 0 2.99-1.34 2.99-3 L15 5 c0-1.66-1.34-3-3-3 S9 3.34 9 5 v6 c0 1.66 1.34 3 3 3 z m5.3-3 c0 3-2.54 5.1-5.3 5.1 S6.7 14 6.7 11 H5 c0 3.41 2.72 6.23 6 6.72 V21 h2 v-3.28 c3.28-.48 6-3.3 6-6.72 h-1.7 z')\n              .fill('transparent').stroke(Colors.foreground).strokeWidth(1.5).width(40).height(40).margin({ right: Spacing.md })\n            Path().commands('M0 0 M24 24 M4 10 v4 M9 6 v12 M14 8 v8 M19 11 v2')\n              .stroke(Colors.foreground).strokeWidth(2).fill('transparent').width(40).height(40)`,
     `Image($r('app.media.ic_mic')).fillColor(Colors.foreground).width(24).height(24).margin({ right: Spacing.md })\n            Image($r('app.media.ic_waveform')).fillColor(Colors.foreground).width(24).height(24)`]
]);
